...
function handleUpgradeToX() {
  #printf "You are starting a major upgrade of the MySQL dogu (from %s to %s)!\\n" "${FROM_VERSION}" "${TO_VERSION}"
  ...
  #echo "Therefore please make sure your harddrive has at least as much free space left as your MySQL database currently occupies!"
  echo ""
}
